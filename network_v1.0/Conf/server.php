...
$title = '服务器信息查看 | Linux下Web服务器环境搭建LNMP一键安装包 | 系统运维（Www.OsYunWei.Com）lnmp-2.6';
...
function find_command($commandName)
{
	...
	$path = array('/bin', '/sbin', '/usr/bin', '/usr/sbin', '/usr/local/install/bin', '/usr/local/install/sbin');
